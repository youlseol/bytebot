...
<CardGroup cols={2}>
  <Card title="Web Browser" icon="globe">
    - Firefox ESR (Extended Support Release) - All architectures
    - Google Chrome (AMD64) / Chromium (ARM64)
...
<Note>
  **Browser Support by Architecture**: 
  - **AMD64/x86_64**: Firefox ESR + Google Chrome Stable
  - **ARM64/aarch64**: Firefox ESR + Chromium (extracted from snap package)
  - Both Chrome/Chromium and Firefox work great for automation tasks
</Note>
