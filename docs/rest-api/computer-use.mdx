...
<Accordion title="application">
  <ParamField body="application" type="string" required>
    The application to switch to. Available options: `firefox`, `chrome`, `1password`, `thunderbird`, `vscode`, `terminal`, `desktop`, `directory`.
  </ParamField>
...
- `chrome` - Google Chrome web browser (falls back to Chromium where available)
